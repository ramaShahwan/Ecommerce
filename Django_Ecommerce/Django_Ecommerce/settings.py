...
SECRET_KEY = 'django-insecure-5ss37pwk0c$3tjd#-43+!(yt_4+6*p^s51dz%6*m7ac&$qa&kw'
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "SmartTech Platform",

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "assets/logo1.png",
    "copyright": "SmartTech Solutions Platform",
    ...
    "welcome_sign": "Welcome to the SmartTech Solutions Platform Administration, Please enter your username and password",
